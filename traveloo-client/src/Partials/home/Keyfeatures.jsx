...
const Keyfeatures = () => {
    return (
        <section className='px-28 my-20 grid grid-cols-2'>
            <div className='px-5'>
                <h4 className='text-primary'>Key features</h4>
                <h2 className='my-4'>We offer best services</h2>
                <p className='my-6'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC.</p>
            ...
            <div className='relative p-5'>
                <div className='w-[440px] h-[660px] rounded-full overflow-hidden'>
                    <img src={feature1} className='h-full w-auto' alt="" />
                </div>

                <div className='w-[350px] h-[500px] rounded-full overflow-hidden border-[24px] border-base relative bottom-96 left-52'>
